...
<head>
    ...
    <link rel="icon" href="{{ isset($settings->app_favicon) && $settings->app_favicon ? $settings->app_favicon : asset('assets/images/xignaturedrive_fav_launcher.png') }}?v={{ get_version() }}">
...
<div id="app"></div>
    ...
    <script>
        let config = {
            ...
            app_logo: '{{ isset($settings->app_logo) && $settings->app_logo ? $settings->app_logo : "assets/images/logo-xignaturedrive.png" }}',
            app_logo_horizontal: '{{ isset($settings->app_logo_horizontal) && $settings->app_logo_horizontal ? $settings->app_logo_horizontal : "assets/images/logo-xignaturedrive.png" }}',
