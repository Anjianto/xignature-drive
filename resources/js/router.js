    ...
    children: [
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/dashboard" */ "./views/Admin/Dashboard"
          ),
        meta: {
          requiresAuth: true,
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/invoices" */ "./views/Admin/Invoices"
          ),
        meta: {
          requiresAuth: true,
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/page-edit" */ "./views/Admin/Pages/PageEdit"
          ),
        meta: {
          requiresAuth: true,
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/user-create" */ "./views/Admin/Users/UserCreate"
          ),
        meta: {
          requiresAuth: true,
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/plan-create" */ "./views/Admin/Plans/PlanCreate"
          ),
        meta: {
          requiresAuth: true,
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/user" */ "./views/Admin/Users/User"
          ),
        meta: {
          requiresAuth: true,
        ...
        children: [
          ...
          },
          {
            ...
            component: () =>
              import(
                /* webpackChunkName: "chunks/user-invoices" */ "./views/Admin/Users/UserTabs/UserInvoices"
              ),
            meta: {
              requiresAuth: true,
              title: "routes_title.invoices",
          ...
          },
          {
            ...
            component: () =>
              import(
                /* webpackChunkName: "chunks/user-delete" */ "./views/Admin/Users/UserTabs/UserIntegration"
              ),
            meta: {
              requiresAuth: true,
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/plan" */ "./views/Admin/Plans/Plan"
          ),
        meta: {
          requiresAuth: true,
        ...
        children: [
          {
            ...
            component: () =>
              import(
                /* webpackChunkName: "chunks/plan-subscribers" */ "./views/Admin/Plans/PlanTabs/PlanSubscribers"
              ),
            meta: {
              requiresAuth: true,
          ...
          },
          {
            ...
            component: () =>
              import(
                /* webpackChunkName: "chunks/plan-settings" */ "./views/Admin/Plans/PlanTabs/PlanSettings"
              ),
            meta: {
              requiresAuth: true,
          ...
          },
          {
            ...
            component: () =>
              import(
                /* webpackChunkName: "chunks/plan-delete" */ "./views/Admin/Plans/PlanTabs/PlanDelete"
              ),
            meta: {
              requiresAuth: true,
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/app-settings" */ "./views/Admin/AppSettings/AppSettings"
          ),
        meta: {
          requiresAuth: true,
        ...
        children: [
          ...
          },
          {
            ...
            component: () =>
              import(
                /* webpackChunkName: "chunks/app-billings" */ "./views/Admin/AppSettings/AppSettingsTabs/Billings"
              ),
            meta: {
              requiresAuth: true,
          ...
          },
          {
            ...
            component: () =>
              import(
                /* webpackChunkName: "chunks/app-email" */ "./views/Admin/AppSettings/AppSettingsTabs/Integration"
              ),
            meta: {
              requiresAuth: true,
              title: "Integration",
          ...
          },
          {
            ...
            component: () =>
              import(
                /* webpackChunkName: "chunks/app-payments" */ "./views/Admin/AppSettings/AppSettingsTabs/Payments"
              ),
            meta: {
              requiresAuth: true,
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/app-language" */ "./views/Admin/Languages/Language"
          ),
        meta: {
          requiresAuth: true,
        },
...
const routesShared = [
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chunks/shared-page" */ "./views/Shared/SharedPage"
      ),
    meta: {
      requiresAuth: false,
    },
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chunks/not-found-shared" */ "./views/Shared/NotFoundShared"
      ),
    meta: {
      requiresAuth: false,
    },
...
const routesAuth = [
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chunks/sign-up" */ "./views/Auth/SignUp/index"
      ),
    meta: {
      requiresAuth: false,
    },
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chunks/forgotten-password" */ "./views/Auth/ForgottenPassword"
      ),
    meta: {
      requiresAuth: false,
    },
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chunks/create-new-password" */ "./views/Auth/CreateNewPassword"
      ),
    meta: {
      requiresAuth: false,
    },
...
const routesUser = [
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chunks/shared-files" */ "./views/FilePages/SharedFiles"
      ),
    meta: {
      requiresAuth: true,
    },
    ...
    children: [
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/profile" */ "./views/User/Settings"
          ),
        meta: {
          requiresAuth: true,
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/settings-password" */ "./views/User/Password"
          ),
        meta: {
          requiresAuth: true,
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/settings-password" */ "./views/User/Integration"
          ),
        meta: {
          requiresAuth: true,
          title: "Integration",
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/settings-invoices" */ "./views/User/Invoices"
          ),
        meta: {
          requiresAuth: true,
          title: "routes_title.invoices",
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/settings-subscription" */ "./views/User/Subscription"
          ),
        meta: {
          requiresAuth: true,
          title: "routes_title.subscription",
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/settings-payment-methods" */ "./views/User/PaymentMethods"
          ),
        meta: {
          requiresAuth: true,
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/settings-create-payment-methods" */ "./views/User/CreatePaymentMethod"
          ),
        meta: {
          requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chunks/upgrade-plan" */ "./views/Upgrade/UpgradePlan"
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chunks/upgrade-billing" */ "./views/Upgrade/UpgradeBilling"
      ),
    meta: {
      requiresAuth: true,
...
const routesMaintenance = [
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chunks/setup-wizard" */ "./views/SetupWizard"
      ),
    meta: {
      requiresAuth: false,
    },
    children: [
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/purchase-code" */ "./views/SetupWizard/PurchaseCode"
          ),
        meta: {
          requiresAuth: false,
        },
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/database" */ "./views/SetupWizard/Database"
          ),
        meta: {
          requiresAuth: false,
        },
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/installation-disclaimer" */ "./views/SetupWizard/InstallationDisclaimer"
          ),
        meta: {
          requiresAuth: false,
        },
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/subscription-service" */ "./views/SetupWizard/SubscriptionService"
          ),
        meta: {
          requiresAuth: false,
        },
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/stripe-credentials" */ "./views/SetupWizard/StripeCredentials"
          ),
        meta: {
          requiresAuth: false,
        },
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/billings-detail" */ "./views/SetupWizard/BillingsDetail"
          ),
        meta: {
          requiresAuth: false,
        },
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/subscription-plans" */ "./views/SetupWizard/SubscriptionPlans"
          ),
        meta: {
          requiresAuth: false,
        },
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/environment-setup" */ "./views/SetupWizard/EnvironmentSetup"
          ),
        meta: {
          requiresAuth: false,
        },
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/app-setup" */ "./views/SetupWizard/AppSetup"
          ),
        meta: {
          requiresAuth: false,
        },
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "chunks/admin-account" */ "./views/SetupWizard/AdminAccount"
          ),
        meta: {
          requiresAuth: false,
        },
...
const routesIndex = [
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chunks/landing-page" */ "./views/Index/SaaSLandingPage"
      ),
    meta: {
      requiresAuth: false,
    },
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chunks/dynamic-page" */ "./views/Index/DynamicPage"
      ),
    meta: {
      requiresAuth: false,
    },
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "chunks/contact-us" */ "./views/Index/ContactUs"
      ),
    meta: {
      requiresAuth: false,
    },
