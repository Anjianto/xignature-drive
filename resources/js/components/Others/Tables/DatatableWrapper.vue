<template>
  <div class="datatable">
    <table v-if="hasData" class="table">
      ...
      <tbody class="table-body">
        <slot v-for="row in data.data" :row="row">
          <DatatableCell :key="row.id" :data="row" />
        </slot>
      </tbody>
    </table>
    ...
    <div v-if="paginator && hasData" class="paginator-wrapper">
      ...
      <ul
        v-if="data.meta.total > 20 && data.meta.last_page <= 6"
        class="pagination"
      >
        <!--Go previous icon-->
        ...
        <li class="page-item next">
          <a
            class="page-link"
            :class="{ disabled: pageIndex + 1 == data.meta.last_page }"
            @click="goToPage(pageIndex + 1)"
          >
      ...
      >
        ...
        <!--Show first Page-->
        <li v-if="pageIndex >= 5" class="page-item" @click="goToPage(1)">
        ...
        <li v-if="pageIndex >= 5" class="page-item">
          <a class="page-link">...</a>
        </li>

        <!--Floated Pages-->
        <template v-if="pageIndex >= 5 && pageIndex < data.meta.last_page - 3">
          <li
        ...
        <li v-if="pageIndex < data.meta.last_page - 3" class="page-item">
          <a class="page-link">...</a>
        </li>

        <template v-if="pageIndex > data.meta.last_page - 4">
          <li
            v-for="(page, index) in 5"
            :key="index"
            class="page-item"
          ...
          >
            <a
              class="page-link"
              :class="{
                active: pageIndex === data.meta.last_page - (4 - index),
              }"
            >
      ...
      <span class="paginator-info">{{
        $t("datatable.paginate_info", {
          visible: data.meta.per_page,
