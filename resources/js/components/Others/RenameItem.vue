<template>
  <PopupWrapper name="rename-item">
    <!--Title-->
    <PopupHeader
      :title="$t('popup_rename.title', { item: itemTypeTitle })"
      icon="edit"
    />
      ...
      >
        ...
        >
          ...
          <div class="input">
            ...
            />
            <div class="close-icon-wrapper" @click="pickedItem.name = ''">
        ...
        <SetFolderIcon
          v-if="isMoreOptions"
          :folder-data="pickedItem"
          :unique_id="pickedItem.unique_id"
        />
  ...
  computed: {
    ...
    moreOptionsTitle() {
      return this.isMoreOptions
        ...
        : this.$t("shared_form.button_folder_icon_open");
    },
  },
  mounted() {
    // Show popup
