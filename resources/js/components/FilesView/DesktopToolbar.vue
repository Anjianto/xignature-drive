<template>
  <div id="desktop-toolbar">
    <div class="toolbar-wrapper">
      <!-- Go back-->
      <div v-if="homeDirectory" class="toolbar-go-back">
      ...
      <div class="toolbar-tools">
        ...
        <!--File Controls-->
        <div
          v-if="$checkPermission(['master', 'editor']) && !$isMobile()"
          class="toolbar-button-wrapper"
        >
          <ToolbarButton
            source="move"
        ...
        <div class="toolbar-button-wrapper">
          <ToolbarButton
            ...
            @click.stop.native="sortingAndPreview = !sortingAndPreview"
          />
          <ToolbarButton
...
export default {
  ...
  computed: {
    ...
    canDeleteInView() {
      ...
      return (
        !this.$isThisLocation(locations) || this.fileInfoDetail.length === 0
      );
    },
    canUploadInView() {
      return !this.$isThisLocation(["base", "public"]);
  ...
  methods: {
    ...
    createFolder() {
      this.$store.dispatch(
        "createFolder",
        this.$t("popup_create_folder.folder_default_name")
      );
    },
    moveItem() {
