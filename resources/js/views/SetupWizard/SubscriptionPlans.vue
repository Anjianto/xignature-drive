  ...
  <AuthContentWrapper ref="auth">
    ...
    <AuthContent name="database-credentials" :visible="true">
      ...
      <ValidationObserver
        ...
        @submit.prevent="subscriptionPlansSubmit"
      >
        <FormLabel>Create your plans</FormLabel>
        <InfoBox>
          <p>
            Your plans will be <b>sorted automatically</b> in ascent order by
            plan price. All plans is automatically created as monthly plans.
          </p>
        </InfoBox>
        ...
        <div class="duplicator">
          <div
            ...
            :key="index++"
            class="plan-item duplicator-item"
          >
            <x-icon
              v-if="index !== 1"
              size="22"
              class="delete-item"
              @click="removeRow(plan)"
            ></x-icon>
  ...
  computed: {
    submitButtonText() {
      return this.isLoading
        ? "Creating Subscription Stripe Plans"
        : "Save and Go Next";
    },
  },
  created() {
