  ...
  <AuthContentWrapper ref="auth">
    ...
    <AuthContent name="subscription-service" :visible="true">
      <div class="content-headline">
        ...
        <h1>Setup Wizard</h1>
        <h2>
          You can charge users for storage space by monthly billing plans.
          Please, select your charging service or skip this step if you don't
          want charge users:
        </h2>
      </div>
        ...
        >
          ...
          <div class="service-content">
            ...
            <p class="service-description">
              You can create custom storage plans and charge your users with
