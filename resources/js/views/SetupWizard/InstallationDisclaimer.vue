  ...
  <AuthContentWrapper ref="auth">
    ...
    <AuthContent name="database-credentials" :visible="true">
      <div class="content-headline">
        ...
        <h1>Setup Wizard</h1>
        <h2>
          Database was installed successfully. Let's set up application, Make
          sure you have these informations before continue:
        </h2>
      </div>
      ...
      <div v-if="!isLoading" class="form block-form">
        <InfoBox>
          <ul v-if="isExtended" style="margin-top: 0" class="information-list">
            ...
            <li>
              5. If you use external storage service, then you will need set
              your API credentials
            </li>
            <li>
              6. Some general settings for VueFileManager like Google Analytics,
              logo, favicon and application name
            </li>
          ...
          <ul v-else style="margin-top: 0" class="information-list">
            ...
            <li>
              2. If you use external storage service, then you will need set
              your API credentials
            </li>
            <li>
              3. Some general settings for VueFileManager like Google Analytics,
              logo, favicon and application name
            </li>
