      ...
      >
        <InfoBox>
          <p>
            ...
            <b>'Local Driver'</b>. For more info, where you can host your files
            .
          </p>
        </InfoBox>
        ...
        <div v-if="storage.driver !== 'local'" class="storage-additionals">
          <div class="block-wrapper">
            <label>Key:</label>
            <ValidationProvider
              v-slot="{ errors }"
          ...
          <div v-if="storage.driver !== 's3'" class="block-wrapper">
          ...
          <InfoBox>
            <p>
              Later, you can edit these data in your <b>.env</b> file which is
