  ...
  <AuthContentWrapper ref="auth">
    ...
    <AuthContent name="database-credentials" :visible="true">
      ...
      >
        ...
        <div class="block-wrapper">
          ...
          >
            <SelectInput
              ...
              placeholder="Select your Stripe currency"
            />
        ...
        <InfoBox>
          <p>
            You have to create webhook endpoint in your Stripe Dashboard. You
            can find it in
            <b>Dashboard -> Developers -> Webhooks -> Add Endpoint</b>. In
            Endpoint URL please copy and paste url bellow. Make sure, this url
            is your public domain, not localhost. In events section, please
            click on <b>receive all events</b>. That's all.
          </p>
        </InfoBox>
        ...
        <div class="block-wrapper">
          ...
          >
            <input
              ...
              placeholder="Type your stripe webhook secret"
              type="text"
              :class="{ 'is-error': errors[0] }"
            />
            <span v-if="errors[0]" class="error-message">{{ errors[0] }}</span>
