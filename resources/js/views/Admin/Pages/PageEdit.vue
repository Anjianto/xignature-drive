<template>
  <div id="single-page">
    <div v-if="!isLoading && page" id="page-content">
              ...
              <div class="inline-wrapper">
                <div class="switch-label">
                  <label class="input-label"
                    >{{ $t("admin_pages.form.visibility") }}:</label
                  >
                  <small class="input-help">{{
                    $t("admin_pages.form.visibility_help")
                  }}</small>
                </div>
                <SwitchInput
                  class="switch"
                  :state="page.data.attributes.visibility"
                  @input="changeStatus"
                />
              </div>
            </div>
...
export default {
  ...
  created() {
    axios.get("/api/pages/" + this.$route.params.slug).then((response) => {
