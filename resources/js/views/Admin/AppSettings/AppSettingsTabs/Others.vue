  ...
  <PageTab :is-loading="isLoading" class="form-fixed-width">
    ...
    <PageTabGroup v-if="app">
      <div class="form block-form">
          ...
          <div class="input-wrapper">
            <div class="inline-wrapper">
              <div class="switch-label">
                ...
                <small
                  class="input-help"
                  v-html="$t('admin_settings.others.storage_limit_help')"
                ></small>
              </div>
              <SwitchInput
        ...
        <div v-if="app.storageLimitation" class="block-wrapper">
          ...
          >
            <input
              ...
              @input="
                $updateText('/settings', 'storage_default', app.defaultStorage)
              "
            />
          ...
          <div class="input-wrapper">
            <div class="inline-wrapper">
              <div class="switch-label">
                ...
                <small
                  class="input-help"
                  v-html="$t('admin_settings.others.allow_registration_help')"
                ></small>
              </div>
              <SwitchInput
                ...
                @input="
                  $updateText('/settings', 'registration', app.userRegistration)
                "
              />
            </div>
          </div>
        ...
        <div class="block-wrapper">
          ...
          >
            <input
              ...
              :class="{ 'is-error': errors[0] }"
              @input="
                $updateText('/settings', 'contact_email', app.contactMail)
              "
            />
            <span v-if="errors[0]" class="error-message">{{ errors[0] }}</span>
          </ValidationProvider>
        ...
        <div class="block-wrapper">
          ...
          >
            <textarea
              ...
              rows="2"
              :placeholder="
                $t('admin_settings.others.mimetypes_blacklist_plac')
              "
              type="text"
              :class="{ 'is-error': errors[0] }"
              @input="
          ...
          <small
            class="input-help"
            v-html="$t('admin_settings.others.mimetypes_blacklist_help')"
          ></small>
        </div>
        ...
        <div class="block-wrapper">
          ...
          >
            <input
              ...
              step="1"
              :class="{ 'is-error': errors[0] }"
              @input="$updateText('/settings', 'upload_limit', app.uploadLimit)"
            />
            <span v-if="errors[0]" class="error-message">{{ errors[0] }}</span>
          </ValidationProvider>
          <small
            class="input-help"
            v-html="$t('admin_settings.others.upload_limit_help')"
          ></small>
        </div>
  ...
  mounted() {
    axios
      .get("/api/settings", {
        params: {
          column:
            "contact_email|google_analytics|storage_default|registration|storage_limitation|mimetypes_blacklist|upload_limit",
        },
      })
      .then((response) => {
