    ...
    <PageTabGroup v-if="app">
      <div class="form block-form">
        ...
        <div class="block-wrapper">
          ...
          >
            <input
              @input="$updateText('/settings', 'app_title', app.title)"
              v-model="app.title"
        ...
        <div class="block-wrapper">
          ...
          >
            <input
              @input="
                $updateText('/settings', 'app_description', app.description)
              "
        ...
        <FormLabel class="mt-70">{{
          $t("admin_settings.appearance.section_appearance")
        }}</FormLabel>
        ...
        <div class="block-wrapper">
          ...
          >
            <ImageInput
              @input="$updateImage('/settings', 'app_logo', app.logo)"
        ...
        <div class="block-wrapper">
          ...
          >
            <ImageInput
              @input="$updateImage('/settings', 'app_favicon', app.favicon)"
  ...
  mounted() {
    axios
      .get("/api/settings", {
        params: {
          column:
            "app_title|app_description|app_logo|app_favicon|app_logo_horizontal",
        },
      })
      .then((response) => {
        this.app = {
