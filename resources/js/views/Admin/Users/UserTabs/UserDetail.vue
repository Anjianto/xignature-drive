    ...
    <PageTabGroup>
      <div class="form block-form">
        ...
        <div class="block-wrapper">
          ...
          <div class="input-wrapper">
            <input
              :value="user.data.attributes.name"
    ...
    <PageTabGroup v-if="config.isSaaS">
      <div class="form block-form">
        ...
        <div class="block-wrapper">
          ...
          <div class="input-wrapper">
            <input
              :value="user.relationships.settings.data.attributes.billing_name"
              type="text"
              disabled
            />
          </div>
        ...
        <div class="block-wrapper">
          ...
          <div class="input-wrapper">
            <input
              :value="
                user.relationships.settings.data.attributes.billing_address
              "
              type="text"
              disabled
            />
        ...
        <div class="block-wrapper">
          ...
          <div class="input-wrapper">
            <input
              :value="
                user.relationships.settings.data.attributes.billing_country
              "
              type="text"
              disabled
            />
        ...
        <div class="wrapper-inline">
          <div class="block-wrapper">
            ...
            <div class="input-wrapper">
              <input
                :value="
                  user.relationships.settings.data.attributes.billing_city
                "
                type="text"
                disabled
              />
          ...
          <div class="block-wrapper">
            ...
            <div class="input-wrapper">
              <input
                :value="
                  user.relationships.settings.data.attributes
                    .billing_postal_code
                "
                type="text"
                disabled
        ...
        <div class="block-wrapper">
          ...
          <div class="input-wrapper">
            <input
              :value="user.relationships.settings.data.attributes.billing_state"
              type="text"
              disabled
            />
          </div>
        ...
        <div class="block-wrapper">
          ...
          <div class="input-wrapper">
            <input
              :value="
                user.relationships.settings.data.attributes.billing_phone_number
              "
              type="text"
              disabled
            />
...
export default {
  ...
  methods: {
    async changeRole() {
      ...
      axios
        .post(
          this.$store.getters.api + "/users/" + this.$route.params.id + "/role",
          {
            attributes: {
              role: this.userRole,
            },
