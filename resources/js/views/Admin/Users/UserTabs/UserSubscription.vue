        ...
        <ListInfo class="list-info">
          <ListInfoItem
            ...
            :content="
              ...
              ' - ' +
              subscription.attributes.capacity_formatted
            "
          />
          <ListInfoItem
            class="list-item"
          ...
          <ListInfoItem
            ...
            :content="subscription.attributes.created_at"
          />
          <ListInfoItem
            class="list-item capitalize"
            :title="$t('user_subscription.renews_at')"
            :content="subscription.attributes.ends_at"
          />
        </ListInfo>
      </div>
      ...
      <div v-if="subscription.attributes.canceled" class="state canceled">
        <ListInfo class="list-info">
          ...
          <ListInfoItem
            ...
            :content="subscription.attributes.canceled_at"
          />
          <ListInfoItem
            class="list-item capitalize"
...
export default {
  ...
  created() {
    axios
      .get("/api/users/" + this.$route.params.id + "/subscription")
      .then((response) => {
