            ...
            <div class="languages-wrapper page-tab from-fixed-width">
              ...
              <div class="all-language-wrapper">
                ...
                >
                  ...
                  >
                    <span class="active-text-theme group-hover-text-theme">{{
            ...
            <div v-if="selectedLanguage">
              ...
              <div v-if="!isSearching">
                    ...
                    <div class="inline-wrapper">
                      <div class="switch-label">
                        ...
                        <small class="input-help">
                          If this language is set as default, app will appear in
                          this language for all users.
                        </small>
                      </div>
                      <SwitchInput
                ...
                <InfoBox class="info-box">
                  <p>
                    Please preserve in your translations special string
                    variables defined in format as
                    <b class="text-theme">:variable</b> or
                    <b class="text-theme">{variable}</b>.
                  </p>
                </InfoBox>
              </div>
  ...
  methods: {
    setDefaultLanguage() {
      this.$updateText(
        "/settings",
        "language",
        this.selectedLanguage.data.attributes.locale
      );
