    ...
    <div id="page-content" v-if="!isLoading">
      ...
      <div class="content-page">
        ...
        <div class="menu-list-wrapper horizontal">
          <router-link
            replace
            :to="{ name: 'PlanSettings', params: { id: plan.id } }"
          ...
          <router-link
            replace
            :to="{ name: 'PlanSubscribers', params: { id: plan.id } }"
            class="menu-list-item link"
          >
            <div class="icon">
          ...
          <router-link
            replace
            :to="{ name: 'PlanDelete', params: { id: plan.id } }"
            class="menu-list-item link"
          >
            <div class="icon">
...
export default {
  ...
  created() {
    axios.get("/api/plans/" + this.$route.params.id).then((response) => {
