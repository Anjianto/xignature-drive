      ...
      <div class="form block-form">
        ...
        <div class="register-card">
          <InfoBox v-show="config.isDemo">
            <p>
              For test your payment please use <b>4242 4242 4242 4242</b> or
              <b>5555 5555 5555 4444</b> as a card number, <b>11/22</b> as the
              expiration date and <b>123</b> as CVC number and ZIP <b>12345</b>.
            </p>
          </InfoBox>
            ...
            <div class="inline-wrapper">
              <div class="switch-label">
                <label class="input-label"
                  >{{ $t("user_add_card.default_title") }}:</label
                >
                <small class="input-help">{{
                  $t("user_add_card.default_description")
                }}</small>
              </div>
              <SwitchInput
...
export default {
  ...
  mounted() {
    ...
    axios.get("/api/stripe/setup-intent").then((response) => {
  ...
  methods: {
    async registerCard() {
      ...
      if (
        !stripe &&
        !card &&
        !this.$refs.stripeCard.classList.contains("StripeElement")
      )
        return;
