        ...
        <div class="order">
          <div class="steps">
            <div class="payment-card">
              <FormLabel>{{
                $t("page_upgrade_account.section_card")
              }}</FormLabel>

              <!-- Pay by new credit card -->
              <div
                v-show="!defaultPaymentMethod || payByNewCard"
                class="register-card"
              >
                <InfoBox v-if="config.isDemo">
                  <p>
                    For test your payment please use
                    <b>4242 4242 4242 4242</b> or <b>5555 5555 5555 4444</b> as
                    a card number, <b>11/22</b> as the expiration date and
                    <b>123</b> as CVC number and ZIP <b>12345</b>.
                  </p>
                </InfoBox>
                ...
                <div v-if="isError" class="card-error-message">
              ...
              <div
                v-if="defaultPaymentMethod && !payByNewCard"
                class="registered-cards"
              >
                <div class="credit-card" :class="{ 'is-error': isError }">
                  <div class="card-number">
                    <img
                      ...
                      :src="
                        $getCreditCardBrand(
                          defaultPaymentMethod.data.attributes.brand
                        )
                      "
                  ...
                  <div class="expiration-date">
                    <span
                      >{{ defaultPaymentMethod.data.attributes.exp_month }} /
                      {{ defaultPaymentMethod.data.attributes.exp_year }}</span
                    >
                  </div>
                </div>

                <!--Change payment-->
                <div v-if="!isError" class="change-payment">
                  <span>
                ...
                <div v-if="isError" class="card-error-message">
                  <span>{{ errorMessage }}</span>
                  <span class="link" @click="payByNewCardForm">
            ...
            <div v-if="billing" class="billing">
              <FormLabel>{{
                $t("page_upgrade_account.section_billing")
              }}</FormLabel>
                ...
                <div class="form block-form">
                  ...
                  <div class="wrapper-inline">
                    ...
                    <div class="block-wrapper">
                      ...
                      >
                        <input
                          v-model="billing.billing_postal_code"
                  ...
                  <div class="block-wrapper">
                    ...
                    >
                      <input
                        v-model="billing.billing_phone_number"
          ...
          <div class="summary">
            ...
            >
              ...
              <div v-if="taxRates" class="row">
                <div class="cell">
                  <b
                    >{{ $t("page_upgrade_account.summary.vat") }} - ({{
                      taxRates.jurisdiction
                    }}
                    {{ taxRates.percentage }}%)</b
                  >
                </div>
                <div class="cell">
