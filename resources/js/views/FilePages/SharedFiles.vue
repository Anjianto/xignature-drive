      ...
      <ContentGroup :title="$t('sidebar.locations_title')">
        <div class="menu-list-wrapper vertical">
          <li
            ...
            :class="{ 'is-active': $isThisLocation(['shared']) }"
            @click="getShared()"
          >
            <div class="icon">
          ...
          <li
            class="menu-list-item link"
            :class="{ 'is-active': $isThisLocation(['participant_uploads']) }"
            @click="getParticipantUploads()"
          >
            <div class="icon">
...
import { LinkIcon, UsersIcon } from "vue-feather-icons";
